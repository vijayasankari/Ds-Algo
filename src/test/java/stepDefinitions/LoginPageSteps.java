...
public class LoginPageSteps {
	...
	public void user_navigates_to_sign_in_page_from_home_page() {
		...
		LoggerReader.info("User is in SignIn page");
	}
	...
	public void user_clicks_login_button_after_providing_empty_or(String username, String password) {
		pageObjectManager.getLoginPage().loginAuthentication(username, password);
	}
	...
	public void hover_text_message_as_appears_below_respective_textbox(String expectedHoverText,
		...
		Assert.assertEquals(pageObjectManager.getLoginPage().hoverText(hoverTextField), expectedHoverText,
				"Hover Text mismatch");
	}
	...
	public void user_should_able_to_see_an_error_message(String expectedErrorMessage) {
		String actualErrorMessage = pageObjectManager.getLoginPage().errorMessage();
	...
	public void user_clicks_register_hyperlink_displayed_at_the_end_of_the_login_page() {
		pageObjectManager.getLoginPage().clickRegisterHyperLinkAtEndOfPage();
	}

	@Then("user should be redirected to Register Page")
	public void user_should_be_redirected_to_register_page() {
		Assert.assertEquals(pageObjectManager.getLoginPage().getTitleCurrentPage().trim(), "Registration",
	...
	public void user_clicks_register_hyperlink_displayed_at_the_top_right_corner_of_the_login_page() {
		pageObjectManager.getLoginPage().clickRegisterHyperLink();
	}
	...
	public void user_clicks_sign_in_hyperlink_displayed_at_the_top_right_corner_of_the_login_page() {
		pageObjectManager.getLoginPage().clickSignInHyperLink();
	}
	...
	public void user_should_be_able_to_see_that_the_page_is_reloaded() {
		Assert.assertEquals(pageObjectManager.getLoginPage().getTitleCurrentPage().trim(), "Login",
				"Login page is not reloaded");
	}

	@When("user clicks NumpyNinja label on the Login page")
	public void the_user_clicks_numpy_ninja_label_on_the_login_page() {
		pageObjectManager.getLoginPage().clickNumpyNinjaLabel();
	}

	@Then("user should be navigated to the Launch page")
	public void the_user_should_be_navigated_to_the_launch_page() {
		Assert.assertEquals(pageObjectManager.getLoginPage().getTitleCurrentPage().trim(), "Numpy Ninja",
	...
	public void user_clicks_the_data_structures_dropdown_from_the_login_page() {
		pageObjectManager.getLoginPage().clickDataStructuresDropdown();
	}
	...
	public void user_selects_from_login_page(String moduleName) {
		pageObjectManager.getLoginPage().clickDataStructuresDropdown();
		pageObjectManager.getLoginPage().selectDropdownValue(moduleName);
	}

	@Then("user should be navigated to the Home page")
	public void user_should_be_navigated_to_the_home_page() {
		Assert.assertEquals(pageObjectManager.getLoginPage().getTitleCurrentPage().trim(), "NumpyNinja",
	...
	@When("user clicks login button after entering username and password read from excel with scenario {string}")
	public void user_clicks_login_button_after_entering_username_and_password_read_from_excel_with_scenario(
			String scenarioName) {
		pageObjectManager.getLoginPage().fetchLoginCredentialsAndLogin(scenarioName);
	}
