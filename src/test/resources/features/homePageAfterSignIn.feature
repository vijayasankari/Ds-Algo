...
Feature: User accessibility verification of Home page after Sign in
  ...
  @HomePageNumpyNinjaLabelAfterSignIn
  ...
  @HomePagModuleSelectionDropdownAfterSignIn
  Scenario Outline: Verify that on clickig dropdown values user able to navigate to module pages
  ...
  @HomePagModuleSelectionAfterSignIn
  Scenario Outline: Verify that on clickig dropdown values user able to navigate to module pages
